...
interface PublishModeSelectorSimpleProps {
  onModeChange: (mode: PublishMode, scheduledDate?: string) => void;
  defaultMode?: PublishMode;
}

export default function PublishModeSelectorSimple({ onModeChange, defaultMode = 'active' }: PublishModeSelectorSimpleProps) {
